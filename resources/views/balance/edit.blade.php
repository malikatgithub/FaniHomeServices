                    ...
                    <div class="card-header main-border ">
                      <h6 class="font-weight-bold text-dark "> <i class="fas fa-dollar-sign brand-color"></i>&nbsp; إضافة رصيد مالي </h6>
                        ...
                        <div class="container">
                                ...
                                <form action="{{route('balance_update',['id'=>$balance->id])}}" method="POST" enctype="multipart/form-data">
                                {{@csrf_field()}}
                                ...
                                <div class="form-row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="text" class="form-control border-danger font-weight-bold" id="validationDefault01" placeholder="" value="{{ $balance->reg_no }}" required name="reg_no" readonly>
                                                        <input type="hidden" class="form-control" id="validationDefault01" placeholder="" value="{{ $balance->captain_id }}" required name="captain_id" readonly>
                                                </div>
        
                                                <div class="col-md-3 mb-3">
                                                        <label for="validationDefault01"> إسم العميل</label>
                                                        <input type="text" class="form-control border-danger font-weight-bold" id="validationDefault01" placeholder="" value="{{ $balance->name }}" required name="name" readonly>
                                                </div>
                
                                                <div class="col-md-3 mb-3">
                                                        <label for="validationDefault01"> رقم الهاتف</label>
                                                        <input type="text" class="form-control border-danger font-weight-bold" id="validationDefault01" placeholder="" value="{{ $balance->phone }}" required name="phone" readonly>
                                                </div>
                                                
                
                                                <div class="col-md-3 mb-3">
                                                        <label for="validationDefault01">المهنة </label>
                                                        <input type="text" class="form-control border-danger font-weight-bold" id="validationDefault01" placeholder="" value="{{ $balance->service->name ?? 'لقد تم ايقاف هذة الخدمة' }}" required name="" readonly>
                                                        <input type="hidden" class="form-control" id="validationDefault01" placeholder="" value="{{ $balance->service_id }}" required name="service_id" readonly>
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="validationDefault01" placeholder="" value="{{ $balance->balance }}" required name="balance">
                                            </div>
                                            
                                            <div class="col-md-12 mb-3">
                                                <label for="exampleFormControlTextarea1"> <span class="required">*</span>  ملاحظات</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="note">{{ $balance->note }}</textarea>
                                            </div>
