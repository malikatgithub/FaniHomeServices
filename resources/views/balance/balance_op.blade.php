            ...
            <div class="col-md-12 text-right mt-4 dir-rtl">
                ...
                <div class="card border-top1">
                    ...
                    <div class="card-header main-border">
                        <h6 class="font-weight-bold"> <i class="fa fa-search"></i> &nbsp; لوحه البحث السريع عن وارد إيصال مالي 

                                <span class="float-left">
                                        <a href="{{asset('balance')}}" class="btn btn-primary text-white"><i class="fa fa-file-alt"></i>&nbsp; إضافة رصيد</a>
                                </span>
